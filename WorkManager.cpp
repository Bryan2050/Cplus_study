...
WorkerManager::WorkerManager()
{
	...
	//{
	//	cout << "职工编号： " << this->workerArray[i]->m_Id
	//		<< " 姓名： " << this->workerArray[i]->m_Name
	//		<< " 部门编号： " << this->workerArray[i]->m_DeptId << endl;
	//}
}
...
void WorkerManager::Add_Emp()
{
	...
	if (addNum > 0)
	{
		//添加
		//计算添加新空间大小
		int newSize = this->workerNum + addNum; // 新空间人数 = 原来记录人数 + 新增人数
...
void WorkerManager::Mod_Emp()
{
	...
	else
	{
		...
		if (ret != -1)
		{
			...
			cout << "修改成功！" << this->workerArray[ret]->m_DeptId << endl;
